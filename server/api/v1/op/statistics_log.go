...
func (statisticsLogApi *StatisticsLogApi) FindStatisticsLog(c *gin.Context) {
	...
	if err, restatisticsLog := statisticsLogService.GetStatisticsLog(statisticsLog.ID); err != nil {
...
func (statisticsLogApi *StatisticsLogApi) GetStatisticsLogList(c *gin.Context) {
	...
	if err, list, total := statisticsLogService.GetStatisticsLogInfoList(pageInfo); err != nil {
