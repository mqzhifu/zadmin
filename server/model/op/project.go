...
type Project struct {
	...
	Status    *bool  `json:"status" form:"status" gorm:"column:status;comment:状态1正常2关闭;"`
	Type      *bool  `json:"type" form:"type" gorm:"column:type;comment:类型,1service 2frontend 3backend 4app;"`
}
