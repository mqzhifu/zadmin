<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="环境变量,local dev test pre online" prop="env" width="120" />
        <el-table-column align="left" label="自定义配置信息" prop="ext" width="120" />
        <el-table-column align="left" label="内容IP" prop="innerIp" width="120" />
        <el-table-column align="left" label="名称" prop="name" width="120" />
        <el-table-column align="left" label="外部IP" prop="outIp" width="120" />
